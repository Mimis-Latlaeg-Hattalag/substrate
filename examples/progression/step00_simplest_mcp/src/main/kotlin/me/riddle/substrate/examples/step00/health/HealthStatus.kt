...
import me.riddle.substrate.examples.step00.MCP_PROTOCOL_VERSION
import java.io.File
...
object HealthProbe {
    ...
    private val startedAt: Instant = Clock.System.now().also { healthLogger.error { "HealthProbe started at $it" } }
